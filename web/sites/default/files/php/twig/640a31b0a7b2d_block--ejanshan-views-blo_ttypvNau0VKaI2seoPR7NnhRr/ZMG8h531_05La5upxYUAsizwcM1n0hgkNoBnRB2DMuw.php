...
/* themes/custom/ejanshan/templates/block/block--ejanshan-views-block--slider-view-block-1.html.twig */
class __TwigTemplate_cbb8b72403efd01ccbb09b9c0886dc20 extends Template
{
    private $source;
    private $macros = [];
...
<div";
        // line 44
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "d-flex justify-content-start", 2 => "min-vw-50"], "method", false, false, true, 44), 44, $this->source), "html", null, true);
        echo ">
  ";
        // line 45
...
";
  ...
  ";
    ...
    {
        return "themes/custom/ejanshan/templates/block/block--ejanshan-views-block--slider-view-block-1.html.twig";
    }
...
<div{{ attributes.addClass(classes,\"d-flex justify-content-start\", \"min-vw-50\") }}>
  {{ title_prefix }}
  {% if label %}
...
", "themes/custom/ejanshan/templates/block/block--ejanshan-views-block--slider-view-block-1.html.twig", "C:\\xampp\\htdocs\\ejanshan\\web\\themes\\custom\\ejanshan\\templates\\block\\block--ejanshan-views-block--slider-view-block-1.html.twig");
    }
